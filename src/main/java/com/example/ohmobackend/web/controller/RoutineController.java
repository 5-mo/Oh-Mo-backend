...
public class RoutineController {
    ...
    public ApiResponse<RoutineResponseDto.RoutineDto> updateRoutineStatus(@PathVariable(name = "routineId") Long routineId, @AuthUser Member member) {
        RoutineResponseDto.RoutineDto routineDto = routineCommandService.updateRoutineStatus(routineId, member);
        return ApiResponse.onSuccess(SuccessStatus.ROUTINE_UPDATE_STATUS_OK, routineDto);
    }
